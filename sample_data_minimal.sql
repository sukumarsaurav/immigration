-- Sample data for users table (if not already populated)
INSERT INTO users (user_id, first_name, last_name, email, phone, password, user_type, status) VALUES
...
INSERT INTO testimonials (testimonial_id, user_id, content, visa_type, rating, status, created_at) VALUES
...
-- Sample data for blog_categories table
INSERT INTO blog_categories (category_id, category_name, slug, description) VALUES
...
-- Sample data for blog_posts table
INSERT INTO blog_posts (post_id, title, slug, content, excerpt, featured_image, status, author_id, published_date, created_at) VALUES
